...
import { Logo } from '../cover/logo/logo.component';
...
export class LeftSidebar {
  @ViewChild('leftSvg', { static: false }) leftSvg?: ElementRef<SVGSVGElement>;
  ...
  ngAfterViewInit(): void {
    ...
    this.rAF(() => {
      const svg = this.leftSvg?.nativeElement;
      if (!svg) return;
